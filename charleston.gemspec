...
Gem::Specification.new do |s|
  ...
  s.date = "2011-11-23"
  s.description = "Charleston is a framework to build static HTML/CSS/JavaScript sites with any combination of HTML, HAML, CSS, SASS, JavaScript, and CoffeeScript, that's easy to put together and maintain."
  ...
  s.files = [
    ...
    "test/fixture/pages/subdir/index.haml",
    "test/helper.rb",
    "test/test_charleston.rb",
    "test/test_checks.rb",
    "test/test_transform.rb"
  ]
  s.homepage = "http://github.com/bkerley/charleston"
  s.require_paths = ["lib"]
  s.rubygems_version = "1.8.10"
  s.summary = "Static HTML site framework"
